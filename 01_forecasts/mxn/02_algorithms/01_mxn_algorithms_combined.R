...
mxn_daily_artifacts_list  <- read_rds("00_models/mxn_daily_artifacts_list.rds")

mxn_prepared_daily_tbl    <- mxn_daily_artifacts_list$data$mxn_prepared_daily_tbl
mxn_prepared_daily_tbl    <- mxn_daily_artifacts_list$data$mxn_forecast_daily_tbl

recipe_weekly_1_spline    <- mxn_daily_artifacts_list$recipes$recipe_spec_mxn

std_weekly_mean           <- mxn_daily_artifacts_list$standardize$std_mxn_mean
std_weekly_sd             <- mxn_daily_artifacts_list$standardize$std_mxn_sd
